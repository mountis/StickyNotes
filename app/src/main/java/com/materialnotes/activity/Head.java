...
public class Head extends Service {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if(inBounded){
                            ...
                            stopService(new Intent(Head.this, Head.class));
                            inBounded = false;
                            break;
                        }
    ...
    private void chathead_click(){
       ...
       // }else{
            Intent it = new Intent(Head.this,MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(it);
        //}
    ...
    private void showMsg(String sMsg){
        if(txtView != null && chatheadView != null ){
            Log.d("Tag", "ChatHeadService.showMsg -> sMsg=" + sMsg);
            txt1.setText(sMsg);
            myHandler.removeCallbacks(myRunnable);
